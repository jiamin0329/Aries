...
#ifndef ARIES_GRIDPRISM_HPP
#define ARIES_GRIDPRISM_HPP

#include "Grid.hpp"

namespace ARIES
{
    class GridPrism: public Grid
    {
    public:
        GridPrism(unsigned long val_point_0, unsigned long val_point_1,
    ...
    private:
        ...
        static unsigned short d_neighborNode[6][3];	/*!< \brief Neighbor to a nodes in the element. */
        static unsigned short d_numNodeFace[5];		/*!< \brief Number of nodes of each face of the element. */
        static unsigned short d_numNeighborNode[6];	/*!< \brief Number of Neighbor to a nodes in the element. */
