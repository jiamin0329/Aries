...
#ifndef ARIES_MATHUTILITIES_HPP
#define ARIES_MATHUTILITIES_HPP
...
namespace ARIES
{
    ...
    public:
         ...
         */
        static void SetVectorToSignalingNaN(std::vector<TYPE>& vector);
         ...
         * @param vector SAMRAI array to set
         */
        static void SetVectorToMax(std::vector<TYPE>& vector);
         ...
         * @param vector SAMRAI array to set
         */
        static void SetVectorToMin(std::vector<TYPE>& vector);
         ...
         * @param vector SAMRAI array to set
         */
        static void SetVectorToEpsilon(std::vector<TYPE>& vector);
    ...
    private:
        ...
        MathUtilities(const MathUtilities& other);

        // Unimplemented assignment operator.
        MathUtilities& operator = (const MathUtilities& rhs);
    ...
    template<>
    bool
    MathUtilities<float>::IsNaN(const float& value);
    ...
    template<>
    bool
    MathUtilities<dcomplex>::IsNaN(const dcomplex& value);
    ...
    template<>
    bool
    MathUtilities<dcomplex>::EqualEps(const dcomplex& a, const dcomplex& b);
    ...
    template<>
    float MathUtilities<float>::Round(float a);
    
    template<>
    double MathUtilities<double>::Round(double a);
} // end namespace ARIES
