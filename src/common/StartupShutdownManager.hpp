...
namespace ARIES
{
    ...
    public:
        ...
        public:
             ...
             */
            virtual bool HasInitialize() = 0;

            /*!
             * @brief Query if handler has startup callback function.
             */
            virtual bool HasStartup() = 0;
        ...
        private:
            ...
            AbstractHandler& operator = (const AbstractHandler& rhs);
        };
         ...
         * @param handler
         */
        static void RegisterHandler(AbstractHandler * handler);
        ...
        /*!
         * @brief Priorities for standard ARIES classes
         */
    ...
    private:
        ...
        // Unimplemented copy constructor.
        StartupShutdownManager(const StartupShutdownManager& other);

        // Unimplemented default constructor.
        StartupShutdownManager& operator = (const StartupShutdownManager& rhs);
         ...
         */
        static const short d_numberOfPriorities = 255;

        /*!
         * @brief Array of singly linked lists holding registered handlers.
         */
        static ListElement* d_managerList[d_numberOfPriorities];

        /*!
         * @brief Array of pointers to ListElement, used for constructing
         * and modifying s_manager_list.
         */
        static ListElement* d_managerListLast[d_numberOfPriorities];

        /*!
         * @brief Number of items at each priority value.
         */
        static int d_numManagerItems[d_numberOfPriorities];

        /*!
         * @brief Flag telling if the singleton been initialized.
         */
        static bool d_singletonInitialized;

        /*!
         * @brief Flags telling if the manager is currently in one of the loops
         * invoking callbacks.
         */
        static bool d_inInitialize;
        static bool d_inStartup;
        static bool d_inShutdown;
        static bool d_inFinalize;
        ...
        static bool d_startuped;
        static bool d_shutdowned;
        static bool d_finalized;
    };
}
