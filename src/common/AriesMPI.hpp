...
namespace ARIES
{
     ...
     *
     *  AriesMPI provides a single point of access in Aries for using MPI
    ...
    public:
         ...
         *  called.
         */
        static void SetCallAbortInParallelInsteadOfMPIAbort(bool flag = true) { d_callAbortInParallelInsteadOfMpiAbort = flag; }
    ...
    private:
        struct DoubleIntStruct { double d; int i; };              /**< @brief Structs for passing arguments to MPI. */
        struct FloatIntStruct { float f; int i; };                /**< @brief Structs for passing arguments to MPI. */
        struct IntIntStruct { int j; int i; };                    /**< @brief Structs for passing arguments to MPI. */
        
        AriesMPI();                                               /**< @brief Unimplemented default constructor. */
        
        AriesMPI::Comm d_comm;                                    /**< @brief Internal communicator. */
        ...
        static AriesMPI d_ariesWorld;                             /**< @brief Primary AriesMPI object. */
        static bool d_callAbortInSerialInsteadOfExit;             /**< @brief Flags to control program abort in AriesMPI::abort(). */
        static bool d_callAbortInParallelInsteadOfMpiAbort;       /**< @brief Flags to control program abort in AriesMPI::abort(). */
